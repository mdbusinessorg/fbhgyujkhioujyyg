    ...
    <section className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-ms-gray/70 max-w-lg mx-auto">4 passos simples para encontrares o emprego ideal</p>
        </div>
          ...
          {steps.map((step, i) => {
            ...
            return (
              <div key={i} className="text-center group">
                ...
                <h3 className="font-heading font-semibold text-ms-dark text-sm mb-1">{step.title}</h3>
                <p className="text-xs text-ms-gray/70">{step.desc}</p>
              </div>
            )
          })}
        </div>
