            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-full bg-[#FFF0F0] flex items-center justify-center flex-shrink-0">
                  <span className="text-[#BC181C] font-bold text-sm">1</span>
                </div>
                <div>
                  <p className="text-sm text-ms-dark/80">Toca no ícone <span className="inline-block">
                    <svg className="w-5 h-5 inline text-[#BC181C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
